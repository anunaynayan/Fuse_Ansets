...
export default function DrawerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 py-10 px-4">
      ...
      <Box className="max-w-3xl mx-auto mb-10 text-center">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
          Drawer Component 
        </h1>
        <p className="text-gray-700 dark:text-gray-300 text-lg">
          Explore different drawer positions (Left, Right, Top, Bottom) with dynamic menu items. Click on the buttons to open the drawers and see the menu in action.
        </p>
      </Box>
